...
from src.gim.context.attention import _patch_sdpa_qkv_scales, _tlens_qkv_scales
from src.gim.context.norm import _swap_norms_with_detach, _tlens_detach_norm_scales
from src.gim.context.softmax import _patch_softmax_backward_T_only

def _is_tlens_model(obj: Any) -> bool:
    # Should capture TransformerLens objects
